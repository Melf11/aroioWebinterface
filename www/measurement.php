...
<? print ${measurement_warning._.$lang} ;
    if ($ini_array['JACKBUFFER'] != "8192") print ${measurement_buffer_warning._.$lang} ; ?><br>
...
<fieldset>
<legend><? print ${measurement_analysis_form._.$lang} ; ?></legend>
<a href="http://www.audiovero.de" target="_blank">
<img class="link" src="audiovero.png" border="0" style="float: right;">
</a>
